...
function AssetRequestHistoryPage() {
  const { id } = useParams();
    ...
    <section className="page-section">
      <div className="page-heading">
        <div>
          ...
          <p>Review every status change and workflow action for this request.</p>
        </div>
        <Link className="secondary-button" to="/employee/asset-requests/my">
          Back to My Requests
        </Link>
      </div>
...
export default AssetRequestHistoryPage;
